Bird Watch is a full stack Flask web applications that allows the user to create a bird-watching list. Users may search from thousands of species anywhere in the world through eBird's API that produces dynamically generated personalized pages for each bird with photos from the Flickr API and song clips from Xeno-Canto's API. 
